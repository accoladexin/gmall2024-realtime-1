...
import com.acco.gmall.realtime.common.bean.TradePaymentBean;
...
public class DwsTradePaymentSucWindow extends BaseAPP {
    ...
    public void handle(StreamExecutionEnvironment env,
        ...
        stream
                ...
                .sinkTo(FlinkSinkUtil.getDorisSink(Constant.DORIS_DATABAES+ "."+Constant.DWS_TRADE_PAYMENT_SUC_WINDOW, "dws_trade_payment_suc_window"));
